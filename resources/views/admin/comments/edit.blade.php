    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url("/admin/article/tags")}}"><i class="fa"></i>  举报原因管理</a></li>
                <li class="active">举报原因编辑</li>
            </ol>
        </section>
                        ...
                        <form role="form" id="postForm">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group edit-box">
                                    <label for="exampleInputEmail1">原因名称</label>
                                    <input type="text" class="form-control input-max-box" class="edit-box" name="reason" value="@if(isset($data['reason'])) {{$data['reason']}} @endif" placeholder="原因名称">
                                </div>
    ...
    @section("js")
        <script>
            function store(){
                $.ajax({
                    type: 'POST',
                    url: "{{url('admin/report/reasons/save')}}",
                    dataType: 'json',
