                        ...
                        <div class="box-header">
                            <h3 class="box-title">
                                ...
                                <div class="input-group input-box input-max-box">
                                    <span class="input-group-addon"><i class="fa">被举报群名</i></span>
                                    <input type="text" class="form-control " name="name" placeholder="被举报群名">
                                </div>
        ...
        <script>
            $(function () {
                var table = $('#datagrid').DataTable({
                    ...
                    columnDefs: [ {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var BtnHtml = "";
                            BtnHtml+= "  <button type='button' class='btn  btn-danger btn-sm delete' data='"+row.id+"' data-name='"+row.reportGroupName+"'>移除</button>";
                            return BtnHtml;
                        }
                    } ],
                    hover:true,
                    ...
                    serverSide: true,
                    ajax: {
                        url: '/admin/reportGroups/get/lists',
                        type: 'GET'
                    },
                    "searching": false,
                ...
                $("#search").on("click",function (e) {
                    ...
                    table.ajax.url( '/admin/reportGroups/get/lists?name='+name).load();
                })
            ...
            $("#datagrid").on("click",".delete",function (e) {
                ...
                layer.confirm('您确定要删除此条记录吗？', {
                    ...
                    $.ajax({
                        type: "delete",
                        url: "{{url('/admin/reportGroups/remove/')}}/"+dataid,
                        dataType: 'json',
                        data: {
                            "_token":"{{csrf_token()}}"
                        },
                        success: function(data){
                            if (data.code==1){
                                ...
                                setTimeout(function () {
                                    ...
                                    window.tableGrid.ajax.url( '/admin/reportGroups/get/lists?name='+name).load();
                                },2000);
                            }else{
                                layer.msg(data.message);
                            }
