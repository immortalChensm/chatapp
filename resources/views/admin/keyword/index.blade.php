                        ...
                        <div class="box-header">
                            <h3 class="box-title">
                                ...
                                <div class="input-group input-box input-max-box">
                                    ...
                                    <input type="datetime-local" class="form-control " name="startDate" placeholder="起始日期">
                                </div>

                                <div class="input-group input-box input-max-box">
                                    <span class="input-group-addon"><i class="fa">终止日期</i></span>
                                    <input type="datetime-local" class="form-control " name="endDate" placeholder="终止日期">
                                </div>
