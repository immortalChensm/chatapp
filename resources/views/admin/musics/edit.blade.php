    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url("/admin/musics")}}"><i class="fa"></i> 音乐管理</a></li>
                <li class="active">音乐编辑</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" id="postForm">
                            ...
                            <input type="hidden" name="musicId" data-id = "@if(isset($data['musicId'])){{$data['musicId']}} @endif" data-user = "@if(isset($data['musicId'])){{$data['userType']}} @endif" value=" @if(isset($data['musicId'])){{$data['musicId']}} @endif">

                            @if(isset($data['musicId']))
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group edit-box">
                                    ...
                                    <input type="text" class="form-control input-max-box" class="edit-box" name="title" value="@if(isset($data['musicId'])) {{$data['title']}} @endif" placeholder="音乐名称">
                                </div>

                                <div class="form-group edit-box">
                                    <label for="exampleInputEmail1">歌手名字</label>
                                    <input type="text" class="form-control input-max-box" class="edit-box" name="singer" value="@if(isset($data['musicId'])) {{$data['singer']}} @endif" placeholder="歌手名字">
                                </div>

                                <div class="form-group" >
                                    <label>音乐简介</label>
                                    <textarea name="introduction"  value="@if(isset($data['musicId'])) {{$data['introduction']}} @endif" class="form-control textarea-input" rows="4">@if(isset($data['musicId'])){{$data['introduction']}} @endif</textarea>
                                </div>

                                <div class="form-group">
                                        <div>
                                            <a id="upload-target" class="btn btn-success btn-success-upload">上传音乐</a>
                                        </div>
                                        <div class="content">
                                            <div class="contentin">
    ...
    @section("js")
        ...
        <script type="text/javascript">
            ...
            var uploader = new Uploader({
                ...
                //将auto配置为false以手动上传
                auto: true,
                allows: ".mp3,.mp4,.wav,.wma,wmv",
                accept: "audio/mp3",        //指定浏览器接受的文件类型 eg:image/*,video/*  =>  IE9及以下不支持
                upName: "imgFile",
                on: {
                    //添加之前触发
                    add: function (task) {
                        if ($(":input[name=musicId]").attr("data-id")>0){
                            if ($(":input[name=musicId]").attr("data-user")!=2){
