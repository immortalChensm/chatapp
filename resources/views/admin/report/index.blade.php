                        ...
                        <div class="box-header">
                            <h3 class="box-title">
                                ...
                                <div class="input-group input-box input-max-box">
                                    <span class="input-group-addon"><i class="fa">用户</i></span>
        ...
        <script>
            $(function () {
                ...
                $("#search").on("click",function (e) {
                    ...
                    table.ajax.url( '/admin/reportUsers/get/users?name='+name).load();
                })
                        ...
                        success: function(data){
                            if (data.code==1){
                                ...
                                setTimeout(function () {
                                    ...
                                    window.tableGrid.ajax.url( '/admin/reportUsers/get/users?name='+name).load();
                                },2000);
                            }else{
                                layer.msg(data.message);
                            }
