                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <p>
                                ...
                                <span style="display:inline-block;margin:3px auto;" class="label @if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canComment)&&$data['loginInfo']->canComment==1)label-success @else label-danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canComment)&&$data['loginInfo']->canComment==1)可评论@else已限制评论@endif</span>
                            </p>
