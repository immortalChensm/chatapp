                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <p>
                                ...
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if($data['isValiated']==1)success @else danger @endif">@if($data['isValiated']==1)已认证@else未认证@endif</span>
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canLogin))success @else danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canLogin))可登录@else已限制登录@endif</span>
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canPost))success @else danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canPost))可发布文章@else已限制文章发布@endif</span>
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canPhoto))success @else danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canPhoto))可发布相册@else已限制发布相册@endif</span>
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canMusic))success @else danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canMusic))可发布音乐@else已限制发布音乐@endif</span>
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canVideo))success @else danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canVideo))可发布视频@else已限制发布视频@endif</span>
                                <span style="display:inline-block;margin:3px auto;" class="label label-@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canComment))success @else danger @endif">@if(!is_null($data['loginInfo'])&&isset($data['loginInfo']->canComment))可评论@else已限制评论@endif</span>
                            </p>
